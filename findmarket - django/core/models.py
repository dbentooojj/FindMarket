...
class Produtos(models.Model):
    ...
    peso_produto = models.FloatField(blank=True, null=True)
    preco_produto = models.FloatField()
    link_logo = models.CharField(max_length=200)
    data_produto = models.CharField(max_length=200)
    volume_produto = models.FloatField(blank=True, null=True)
